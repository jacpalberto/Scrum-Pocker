...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    val fibonacciDeck = listOf(Card("0"), Card("1"), Card("2"), Card("3"), Card("5"), Card("8"), Card("13"),
            Card("21"), Card("34"), Card("55"), Card("89"), Card("144"), Card(type = "infinite"),
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (id) {
            ...
            R.id.menu_tshirt -> updateRvCards(TSHIRT_TYPE)
            R.id.menu_settings -> showSettingsDialog()
            R.id.menu_about -> toast("AboutClicked")
        }
